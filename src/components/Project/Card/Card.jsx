            ...
            <div className='card__details'>
                ...
                <div className='card__details__bottom'>
                                ...
                                props.stack.length > 4 ? (
                                    <div className='stack__view__more'>
                                        <div className='more__btn' onClick={() => setOpenStackExpandBar(!openStackExpandBar)}>
                                            View More <MdExpandMore style={{ transition: "all 0.4s" }} className={openStackExpandBar ? 'rotate' : ""} />
                                        </div>
                                        <div
                    ...
                    <div className='button__container'>
                        <a href={props.demoLink} target='__blank' className='bnt btn__primary'>Demo</a>
